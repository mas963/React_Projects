            ...
            <div className="flex flex-col gap-y-3">
              <div className="flex gap-x-3">
                ...
                <label className="relative flex-1 group">
                  ...
                  <span
                    className="absolute top-0 left-0 h-full flex items-center px-4 text-sm text-gray-500 transition-all group-focus-within:text-xs group-focus-within:text-purple-600 peer-valid:h-7 peer-valid:text-xs peer-valid:text-purple-600">
                    Telefon Numarası
                  </span>
                </label>
              </div>
